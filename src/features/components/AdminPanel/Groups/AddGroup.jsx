...
import { Button,
  Form,
  Select, Input,Typography, message } from 'antd';
...
<div className='div_child_add'>
    ...
    className='addGroupForm' 
      ...
      >
        ...
        <Typography.Title style={{textAlign:'center',color:'teal'}}>Add Group!</Typography.Title>
        <Form.Item
        ...
        >
          <Input placeholder='Enter  Group name'  onChange={(e)=>setGroup({...group,name:e.target.value})}
          />
        </Form.Item>

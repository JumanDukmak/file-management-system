...
import { Col, Divider, Row ,Avatar, Card ,Space, message, Button} from 'antd';
...
import {   CheckInFileRequest, CheckOutFileRequest, getGroupFilesStart, getGroupUsersStart, getHistoryFileStart, removeFileStart, removeMemberStart, resetData } from '../../../redux/Groups/groupSlice';
...
useEffect(()=>{
 ...
 {/* -----------------------------------------------------Users--------------------------------------------------- */}
        ...
        <div style={{color:'teal',fontSize:'18px',fontWeight:'600'}}>Users</div>
